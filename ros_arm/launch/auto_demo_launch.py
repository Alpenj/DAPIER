...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'period_seconds',
            default_value='1.0',
            description='Seconds between test poses',
        ),
        DeclareLaunchArgument(
            'amplitude_degrees',
            default_value='10.0',
            description='Joint test angle around the 90-degree center',
        ),
        Node(
        ...
        Node(
            ...
            parameters=[{
                'period_seconds': LaunchConfiguration('period_seconds'),
                'amplitude_degrees': LaunchConfiguration('amplitude_degrees'),
            }],
            output='screen',
        ),
        Node(
