...
def record_step(teacher):
    ...
    row=dict(grippers=grippers,warnings=d.warning.number.tolist(),phase=teacher.phase,
        ...
        general_evidence_status=status["general_evidence_status"],
        general_provable_clearance_m=status["general_provable_clearance_m"],
        general_clearance_is_provable=status["general_clearance_is_provable"],
